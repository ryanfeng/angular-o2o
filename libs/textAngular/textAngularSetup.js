...
.factory('taToolFunctions', ['$window','taTranslations', function($window, taTranslations) {
	return {
		imgOnSelectAction: function(event, $element, editorScope){
			...
			editorScope.displayElements.popover.css('width', '420px');
			...
			var threeQuartButton = angular.element('<button type="button" class="btn btn-default btn-sm btn-small" unselectable="on" tabindex="-1">75% </button>');
			threeQuartButton.on('click', function(event){
				event.preventDefault();
				$element.css({
					'width': '75%',
					'height': ''
			...
			buttonGroup.append(threeQuartButton);
